 ...
 * Screening
 *
 * @ORM\Table(name="zk_screenings", indexes={@ORM\Index(name="movie", columns={"movie"}), @ORM\Index(name="cinema", columns={"cinema"}), @ORM\Index(name="type", columns={"type"}), @ORM\Index(name="dubbing", columns={"dubbing"}), @ORM\Index(name="subtitles", columns={"subtitles"})})
