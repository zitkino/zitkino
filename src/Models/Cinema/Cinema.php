...
use App\Models\Screening\{Screening, Screenings};
...
class Cinema implements TranslatableInterface {
	...
	#[ORM\ManyToOne(targetEntity: CinemaType::class, inversedBy: "cinemas")]
	...
	#[ORM\OneToMany(mappedBy: "cinema", targetEntity: Screening::class, cascade: ["persist", "remove"])]
	public Collection $screenings {
		get => $this->screenings;
		set => $this->screenings = $value;
	}
	
	#[ORM\OneToMany(mappedBy: "cinema", targetEntity: Place::class)]
